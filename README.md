# Projeto Banco de Dados - Gestão de Equipamentos
...
1.  **DDL (Estrutura):** Criação do banco e das tabelas (`Usuario`, `Equipamento`, `Emprestimo`, `Manutencao`) com chaves primárias e estrangeiras.
2.  **DML (Dados):** Inserção de dados de teste para popular as tabelas.
...
3.  Execute o script completo para criar o banco, inserir os dados e testar as consultas.

---
*Atividade entregue para avaliação de manipulação de dados SQL.*
